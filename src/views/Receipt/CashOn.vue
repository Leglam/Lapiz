      ...
      <div class="order-details">
        ...
        <div class="order-status-box">
          ...
          <p class="status-message">
            ...
            ขณะนี้สินค้ากำลังอยู่ในขั้นตอนการจัดส่ง<br>
            โปรดเตรียมเงินสดให้พร้อมเพื่อชำระค่าสินค้าส่วนที่เหลือ ณ ขณะรับสินค้า
          </p>
          <p class="status-message">
            หากท่านประสงค์จะแก้ไข หรือยกเลิกคำสั่งซื้อ กรุณาติดต่อเราผ่านช่องทาง 
            Facebook: Lapiz Thailand หรือ Line: @Lapizshoes
          </p>
          <p class="status-message">
            หมายเหตุ: หากท่านปฏิเสธที่จะรับสินค้า หรือชำระค่าสินค้าตามที่แจ้งไว้ คำสั่งซื้อจะถูกยกเลิกโดยอัตโนมัต
          </p>
        </div>
          ...
          <div class="customer-info-content">
            ...
            <div class="info-column">
              <div class="info-section">
                ...
                <p>Cash on Delivery 4,300.00 THB</p>
              </div>
