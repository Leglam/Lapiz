      ...
      <div class="order-details">
        ...
        <div class="order-status-box">
          ...
          <p class="status-message">
            ...
            โปรดเตรียมเงินสดให้พร้อมเพื่อชำระค่าสินค้าส่วนที่เหลือ ณ
            ขณะรับสินค้า
          </p>
          <p class="status-message">
          ...
          <p class="status-message">
            หมายเหตุ: หากท่านปฏิเสธที่จะรับสินค้า หรือชำระค่าสินค้าตามที่แจ้งไว้
            คำสั่งซื้อจะถูกยกเลิกโดยอัตโนมัต
          </p>
        </div>
