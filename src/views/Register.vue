        ...
        <div class="form-groups">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    @blur="checkUsername"
                >
                <p v-if="usernameError && username.length > 0" class="error-message">ชื่อผู้ใช้นี้ไม่สามารถใช้ได้</p>
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    @blur="checkEmail"
                >
                <p v-if="emailError && email.length > 0" class="error-message">อีเมลนี้ถูกใช้ไปแล้ว</p>
            </div>
            ...
            <div class="form-group">
                ...
                >
                <p v-if="passwordError && password.length > 0" class="error-message">รหัสผ่านต้องมีอย่างน้อย 8 ตัว และต้องประกอบด้วยตัวอักษรพิมพ์ใหญ่, ตัวพิมพ์เล็ก และตัวเลข</p>
            </div>
            ...
            <div class="form-group">
                ...
                >
                <p v-if="confirmPasswordError" class="error-message">รหัสผ่านไม่ตรงกันหรือกรุณากรอกรหัสผ่านก่อน</p>
            </div>
...
const handleSubmit = () => {
  ...
  if (!usernameError.value && !emailError.value && !passwordError.value && !confirmPasswordError.value) {
    console.log('Registering user:', { firstName: firstName.value, lastName: lastName.value, username: username.value, email: email.value, password: password.value });
  }
};
</script>
